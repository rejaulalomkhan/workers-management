        ...
        <div class="w-full lg:w-2/3 xl:w-3/4 space-y-6">
            ...
            <div x-show="tab === 'overview'" x-transition.opacity>
                ...
                <div class="grid grid-cols-2 gap-3 sm:gap-4 mb-6">
                    ...
                    @foreach($categoryStats as $tradeName => $stat)
                    <!-- Dynamic Card for {{ $tradeName }} -->
                    <div class="bg-white p-4 sm:p-5 rounded-xl border-t-4 border-indigo-500 shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
                        <div class="relative z-10">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <p class="text-xs sm:text-sm text-gray-500 font-bold uppercase tracking-tight">{{ $tradeName }} Overview</p>
                            </div>
                                    ...
                                    <div class="flex items-center gap-3 sm:gap-4">
                                        ...
                                        <div class="text-left leading-tight">
                                            ...
                                            <div class="flex flex-wrap items-center gap-2 mt-2">
                                                @if(isset($dateData['category_hours']))
                                                    @foreach($dateData['category_hours'] as $catName => $cHrs)
                                                        @if($cHrs > 0)
                                                            <div class="text-[9px] sm:text-[10px] text-indigo-600 flex items-center gap-1 bg-indigo-50 px-1.5 py-0.5 rounded border border-indigo-100">
                                                                <span class="uppercase font-semibold tracking-wider">{{ $catName }}:</span>
                                                                <span class="font-black">{{ $cHrs }}h</span>
                                                            </div>
                                                        @endif
                                                    @endforeach
                                                @endif
